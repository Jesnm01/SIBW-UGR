...
insert into eventos (nombre, lugar, fecha, organizadores, path_foto_cabecera, descripcion, twitter, facebook, publicado) 
...
'https://twitter.com/tomorrowland', 'https://es-es.facebook.com/tomorrowland/', 1
);

insert into eventos (nombre, lugar, fecha, organizadores, path_foto_cabecera, descripcion, twitter, facebook, publicado)  values 
...
'https://twitter.com/creamfields','https://www.facebook.com/OfficialCreamfields/', 1
);

insert into eventos (nombre, lugar, fecha, organizadores, path_foto_cabecera, descripcion, twitter, facebook, publicado)
values ('Mad Cool Festival 2021', 'Madrid, España', '7-10 Julio', '???', 'images/madcool.jpg', 'descripcion por completar','https://twitter.com/','https://www.facebook.com/', 0);

insert into eventos (nombre, lugar, fecha, organizadores, path_foto_cabecera, descripcion, twitter, facebook, publicado)
values ('Arenal Sound 2021', 'Burrianas, Valencia', '27 Julio - 1 Agosto', '???', 'images/arenal-sound.jpg', 'descripcion por completar','https://twitter.com/','https://www.facebook.com/', 0);

insert into eventos (nombre, lugar, fecha, organizadores, path_foto_cabecera, descripcion, twitter, facebook, publicado)
values ('Dreambeach 2021', 'Villaricos, Almería', '4-8 Agosto', '???', 'images/dreambeach.jpg', 'descripcion por completar','https://twitter.com/','https://www.facebook.com/', 0);

insert into eventos (nombre, lugar, fecha, organizadores, path_foto_cabecera, descripcion, twitter, facebook, publicado)
values ('Defqon 1 2021', 'Biddinghuizen, Países Bajos', '25-27 Junio', '???', 'images/defqon1.jpg', 'descripcion por completar','https://twitter.com/','https://www.facebook.com/', 0);

insert into eventos (nombre, lugar, fecha, organizadores, path_foto_cabecera, descripcion, twitter, facebook, publicado)
values ('EDC Portugal 2021', 'Praia da Rocha, Portugal', '18-20 Junio', '???', 'images/edc_portugal.jpg', 'descripcion por completar','https://twitter.com/','https://www.facebook.com/', 0);

insert into eventos (nombre, lugar, fecha, organizadores, path_foto_cabecera, descripcion, twitter, facebook, publicado)
values ('Mysteryland 2021', 'Ámsterdam, Paises Bajos', '27-29 Agosto', '???', 'images/mysteryland.jpg', 'descripcion por completar','https://twitter.com/','https://www.facebook.com/', 0);

insert into eventos (nombre, lugar, fecha, organizadores, path_foto_cabecera, descripcion, twitter, facebook, publicado)
values ('Coachella 2021', 'California, Estados Unidos' ,'9-11 Abril', '???', 'images/Coachella.jpg', 'descripcion por completar','https://twitter.com/','https://www.facebook.com/', 0);
