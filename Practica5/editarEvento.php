<?php
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Si el campo de las etiquetas en el formulario esta vacio, que no me añada nada (por lo que no habra ningun registro en la tabla y no me apareceran los tags en la pagina del evento)
    if(!empty($_POST['tags'])){
